...
urlpatterns = [
    ...
    path('admin-assignment', assignment_views.admin_assignment_view, name='admin-assignment'),
    path('admin-add-assignment', assignment_views.admin_add_assignment_view, name='admin-add-assignment'),
    path('admin-view-assignment', assignment_views.admin_view_assignment_view, name='admin-view-assignment'),
    path('admin-delete-assignment/<int:pk>/', assignment_views.admin_delete_assignment_view,name='admin-delete-assignment'),
    path('admin-view-student-grades', assignment_views.admin_view_student_grades_view,name='admin-view-student-grades'),
    path('admin-view-submissions/<int:pk>', assignment_views.admin_view_grades_view,name='admin-view-submissions'),
    path('admin-check-grades/<int:pk>', assignment_views.admin_check_grades_view,name='admin-check-grades'),
